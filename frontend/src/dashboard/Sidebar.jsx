...
const NAV_ITEMS = [
  ...
  { id: 'violations', icon: '⚠', label: 'Logs' },
  { id: 'zones', icon: '◉', label: 'Area Alerts' },
]
    ...
    >
      ...
      <nav style={{ display: 'flex', flexDirection: 'column', gap: 4, flex: 1 }}>
        {NAV_ITEMS.map((item) => (
          <button
            ...
            onMouseEnter={(event) => {
              if (activeTab !== item.id) event.currentTarget.style.background = 'rgba(255,255,255,0.05)'
            }}
            onMouseLeave={(event) => {
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
        ...
        <button
          ...
          onMouseEnter={(event) => {
            event.currentTarget.style.color = '#FF2D55'
            event.currentTarget.style.borderColor = 'rgba(255,45,85,0.3)'
          }}
          onMouseLeave={(event) => {
            event.currentTarget.style.color = 'rgba(240,237,232,0.3)'
